defmodule Pulse.Dispatcher do
  @moduledoc """
  Fans out each parsed `Pulse.Event.LogNotification` to every running sink. Wired in as
  ...
  def broadcast(notification) do
    Registry.dispatch(Pulse.SinkRegistry, :sink, fn entries ->
